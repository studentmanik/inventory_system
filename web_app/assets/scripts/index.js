    ...
    return {
        ...
        initDashboardDaterange: function () {
            ...
            function (start, end) {
				...
				//start custom code by payer
				$('#dashboard-report-range #date_frm').html(start.format('DD-MM-YYYY'));
				$('#dashboard-report-range #date_to').html(end.format('DD-MM-YYYY'));
				var date_frm = $('#dashboard-report-range #date_frm').text();
				var date_to = $('#dashboard-report-range #date_to').text();
				get_data(date_frm,date_to);
				//end custom code by payer
            }
            );
