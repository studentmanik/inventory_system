var Charts = function () {
    ...
    return {
        ...
        initPieCharts: function () {
            var chat_Data_name_array  = ["Product Line A","Product Line B","Product Line C","Product Line D"];
            var chart_data_array = [3000000,4000000,5000000,500000];
            var data = [];
            var series = chart_data_array.length + 1;
            //series = series < 2 ? 2 : series;
			
            
            for (var i = 0; i < chart_data_array.length; i++) {
                data[i] = {
                    label: chat_Data_name_array[i],//"Series" + (i + 1),
                    data: chart_data_array[i] //Math.floor(Math.random() * 100) + 1
                }
            }
